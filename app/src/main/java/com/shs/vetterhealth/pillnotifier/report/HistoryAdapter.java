package com.shs.vetterhealth.pillnotifier.report;
...
import com.shs.vetterhealth.pillnotifier.views.RobotoRegularTextView;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryViewHolder> {
    ...
    public HistoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pillnotifier_row_history, parent, false);
