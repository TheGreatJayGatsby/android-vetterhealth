...
import com.shs.vetterhealth.pillnotifier.addmedicine.AddMedicineActivity;
import com.shs.vetterhealth.pillnotifier.data.source.MedicineAlarm;
import com.shs.vetterhealth.pillnotifier.views.RobotoLightTextView;
...
public class MedicineFragment extends Fragment implements MedicineContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.pillnotifier_fragment_medicine, container, false);
